...
<div id="bottomNav" class="box">
 <div class="box_1">
  <div class="bNavList clearfix">
   ...
   <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_88039000_1398343163');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_88039000_1398343163']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
        <a href="<?php echo $this->_var['nav_0_88039000_1398343163']['url']; ?>" <?php if ($this->_var['nav_0_88039000_1398343163']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_88039000_1398343163']['name']; ?></a>
